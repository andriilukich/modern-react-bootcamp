...
class FullHouse extends Rule {
  evalRoll = dice => {
    ...
    // return this.freq(dice).some(c => c === 3) ? this.score : 0;
  }
};
...
const fullHouse = new FullHouse({ score: 25, description: '25 points for the Full-House' });

// small/large straights score as 30/40
const smallStraight = new SmallStraight({ score: 30, description: '30 points for the small Straight' });
const largeStraight = new LargeStraight({ score: 40, description: '40 points points for the large Straight' });

// yahtzee scores as 50
const yahtzee = new Yahtzee({ score: 50, description: '50 points for the Yahtzee' });
